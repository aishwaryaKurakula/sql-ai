...
class SidebarProvider {
  ...
  _getHtmlForWebview(webview) {
    ...
    html = html.replace(
      "<head>",
      `<head><meta http-equiv="Content-Security-Policy" content="default-src 'none'; img-src ${webview.cspSource} https: data:; style-src ${webview.cspSource} 'unsafe-inline' 'self'; script-src 'nonce-${nonce}'; connect-src http: https:; font-src ${webview.cspSource} data: https:;">`
    )
    return html
  }
}
